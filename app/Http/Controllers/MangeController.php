...
class MangeController extends Controller
{
    ...
    [
        'id' => 1,
        'thumbnail' => 'https://www.youtube.com/watch?v=nEWkWcrz9Zo',
        'title' => 'Never Gonna Give You Up (Official Music Video)',
        'uploader_img' => 'https://yt3.ggpht.com/ytc/AAUvwnjJ1F4zvBz0-7Zw1HvvjvlL4KnJKfZzDklcT=s88-c-k-c0x00ffffff-no-rj',
        'uploader_name' => 'Rick Astley',
        'views' => '1.2B views',
        'duration' => '3:33',
        'time_passed' => '13 years ago',
    ],
    [
        'id' => 2,
  ...
  [
    ...
    protected $user_id = Auth::user()->UserID;
